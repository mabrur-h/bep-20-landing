    ...
    return (
        <section id="fast-speed" className="py-5">
            <Container fluid className="py-5">
                <div className="row align-items-center justify-content-center my-5 py-5 fast-speed-row">
                    ...
                    <div className="col-12 col-lg-6 d-flex align-items-center justify-content-center" data-aos="fade-left">
                        <div className="d-flex align-items-center justify-content-center flex-column w-75 fast-speed-content-row">
                            ...
                            <div className="fast-speed-btn-wrapper">
